...
const MobileSidebar = ({ isOpen, setIsOpen, auth }) => {
    ...
    return (
        <>
            ...
            ></div>
            <div
                className={`overflow-y-scroll absolute w-[80vw] flex flex-col justify-between z-50 top-0 left-0 bg-white duration-300 h-screen border-2 text-neutral-80 text-[3.2vw] ${
                    isOpen
                        ? "translate-x-[0%]"
