        ...
        <header className="fixed w-screen top-0 right-0 bg-white text-dark lg:text-base z-50">
            ...
            <nav className="container flex flex-wrap justify-between items-center mx-auto h-24 md:h-20 xl:h-32 3xl:h-48 duration-500">
                <div className="w-auto px-4">
                    <Link href="/">
                        <img
                            className="h-8 md:h-5 xl:h-8 3xl:h-10 md:mb-2"
                            src={logo}
                            alt="Goals Academy"
                        />
                    </Link>
                ...
                {!auth.user ? (
                    ...
                    <div className="w-auto hidden md:flex flex-wrap justify-end items-center md:gap-3 xl:gap-4 3xl:gap-6 font-medium">
                        ...
                        >
                            ...
                            <TECollapse
                                show={authDropdown}
                                className="absolute z-10 mt-4 shadow-none p-2"
                            >
                                {/* profile navbar */}
                                <TECollapseItem>
                                    <Link
            ...
            <div
                className={`md:hidden w-full absolute z-50 top-0 right-0 bg-white font-bold text-white h-screen py-8 duration-500 ${
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid gap-8">
                        ...
                        <button
                            ...
                            onClick={() =>
                                setProfileDropdownMobile(!profileDropdownMobile)
                            }
                        >
                            <span
                            ...
                            >
                                ...
                                <CornerWaveVector cornerClassName="w-4/12" />
                                <i
                                    className={`fa-solid fa-chevron-down text-24 duration-300 ${
                            ...
                            <TECollapse
                                ...
                                className="absolute mt-12 text-dark shadow-none p-1 w-full"
                            >
                                <TECollapseItem>
                                    <Link
