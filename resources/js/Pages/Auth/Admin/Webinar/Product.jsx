...
export default function Product({ auth, webinar, categories }) {
    ...
    const onSearchCallback = (search) => {
        router.visit(
            route("admin.webinar.product.index", { search: search }),
            {
                only: ["webinar"],
            }
        );
    ...
    async function getWebinarDetail(id) {
        setIsLoading(true);
        setProduct(null);
        axios.get("/admin/webinar/product/" + id).then((res) => {
            ...
            },
            {
                ...
                Cell: ({ cell }) => (
                    <GoalsCupertinoButton
                        ...
                        setIsEnabled={() => {
                            router.put(
                                route("admin.webinar.product.updateVisible", {
                ...
                <div className="space-y-[1.6vw]">
                    <SubHeading title="Produk">
                        <GoalsButton
                            ...
                            method="GET"
                            size="sm"
                            href={route("admin.webinar.product.create")}
