...
export default function Product({ auth, produk_digital, categories }) {
    const [isLoading, setIsLoading] = useState(false);
    produk_digital = produk_digital.data;
    ...
    const onSearchCallback = (search) => {
        router.visit(
            route("admin.produk_digital.product.index", { search: search }),
            {
                only: ["produk_digital"],
            }
        );
    ...
    const callback = (method) => {
        router.visit(route("admin.produk_digital.product.index"), {
            only: ["produk_digital"],
            onSuccess: () => {
                if (method == "create") {
            ...
            },
            {
                ...
                Cell: ({ cell }) => (
                    <GoalsCupertinoButton
                        ...
                        setIsEnabled={() => {
                            router.put(
                                route("admin.produk_digital.product.updateVisible", {
                        ...
                        <ul className="flex gap-[.8vw] w-fit">
                            <li>
                                <Link
                                    ...
                                    method="GET"
                                    href={route(
                                        "admin.produk_digital.product.edit",
                ...
                <div className="space-y-[1.6vw]">
                    <SubHeading title="Produk">
                        <GoalsButton
                            ...
                            method="GET"
                            size="sm"
                            href={route("admin.produk_digital.product.create")}
