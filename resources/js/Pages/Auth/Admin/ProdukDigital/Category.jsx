...
export default function Category({ auth, categories, message }) {
    ...
    const onSearchCallback = (search) => {
        router.visit(
            route("admin.produk_digital.category.index", { search: search }),
            {
                only: ["categories"],
            }
        );
    ...
    const callback = (method) => {
        router.visit(route("admin.produk_digital.category.index"), {
            only: ["categories"],
            onSuccess: () => {
                if (method == "create") {
                ...
                Cell: ({ cell }) => (
                    <GoalsCupertinoButton
                        ...
                        setIsEnabled={() => {
                            router.put(
                                route(
                                    "admin.produk_digital.category.updateVisible",
