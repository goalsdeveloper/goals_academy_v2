...
export default function Product({ auth, skripsiMastery, categories }) {
    const [isLoading, setIsLoading] = useState(false);
    skripsiMastery = skripsiMastery.data;
    ...
    const onSearchCallback = (search) => {
        router.visit(
            route("admin.skripsi_mastery.product.index", { search: search }),
            {
                only: ["skripsiMastery"],
            }
        );
                        ...
                        <ul className="flex gap-[.8vw] w-fit">
                            <li>
                                <Link
                                    ...
                                    method="GET"
                                    href={route(
                                        "admin.skripsi_mastery.product.edit",
                ...
                <div className="space-y-[1.6vw]">
                    <SubHeading title="Produk">
                        <GoalsButton
                            ...
                            method="GET"
                            size="sm"
                            href={route("admin.skripsi_mastery.product.create")}
