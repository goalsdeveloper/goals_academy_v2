    ...
    return (
        <div className="flex justify-end gap-[.25vw] font-sans font-medium text-[1vw]">
            ...
            <GoalsSelectInput
                ...
                className="flex-row-reverse md:justify-end gap-[.5vw] text-[.7vw] md:px-[1vw] md:w-[8.35vw] md:h-[2.1vw] border-1"
                filledClassName=""
                emptyClassName=""
            >
            ...
            <GoalsSelectInput
                ...
                className="flex-row-reverse md:justify-end gap-[.5vw] text-[.7vw] md:px-[1vw] md:w-[16.25vw] md:h-[2.1vw] border-1"
                filledClassName=""
                emptyClassName=""
            >
