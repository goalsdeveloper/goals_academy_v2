...
function NotifikasiItem ({ item }) {
    if (item.category == 'Transaksi') {
        return (
            <Link href="" className="relative w-full flex justify-between items-center shadow-centered-spread rounded-[1vw] p-[4vw] md:p-[2vw] hover:bg-soft">
                <div className="flex flex-col w-11/12 gap-[2vw] md:gap-[.5vw]">
                    ...
                    <div className="flex items-center gap-[2vw] md:gap-[.5vw]">
                        <img src={`/img/purchase/${item.payment_method.toLowerCase()}.png`} className="w-[10vw] h-[10vw] md:w-[4.5vw] md:h-[4.5vw]" alt={item.payment_method} />
                        <div>
                ...
                <div className={`${item.is_read ? 'hidden' : ''} bg-secondary rounded-full w-[3.5vw] h-[3.5vw] md:w-[1.3vw] md:h-[1.3vw] md:me-[1vw]`}></div>
            </Link>
        )
    } else {
        return (
