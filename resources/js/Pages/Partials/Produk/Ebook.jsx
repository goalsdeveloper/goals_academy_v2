...
export default function Ebook ({ data, active, status }) {
    return (
        <section id="ebook" className={`${active || status ? '' : 'hidden'} my-8 xl:my-12 3xl:my-16 overflow-hidden`}>
                    ...
                    {data.map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`flex ${model}`}>
                                <EbookCard key={index} item={item} className="md:w-[21vw] 3xl:w-[20vw]" />
                            </div>
                        )
                    })}
                </div>
        ...
        <div className="container mx-auto md:hidden">
            <div className="flex justify-between mb-6 xs:mb-8">
                <div className="md:w-6/12">
                    <h2 className="text-[5vw]">E-Book <span className="text-primary">Skripsi</span></h2>
                </div>
