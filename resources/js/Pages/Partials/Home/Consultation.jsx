            ...
            <div className="md:container mx-auto">
                <div className="flex flex-wrap items-center shadow-centered xl:rounded-2xl p-8 md:p-14 lg:p-18 xl:p-24 3xl:p-32">
                    <div className="w-8/12 md:w-7/12 text-start">
                        <h3 className="mb-2 lg:mb-3 xl:mb-4 text-14 sm:text-16 md:text-14 lg:text-18 xl:text-24 3xl:text-32 leading-normal">Masih Bingung Program Apa yang <br /><span className="text-primary">Sesuai dengan Kebutuhanmu?</span></h3>
                        <p className="text-10 md:text-8 lg:text-10 xl:text-12 3xl:text-16">Mari konsultasikan program yang cocok dan sesuai kebutuhanmu sekarang juga.</p>
                    </div>
                    <div className="w-4/12 md:w-5/12 flex justify-center md:justify-end">
                        <a href="https://wa.me/6285637564245" className="w-10/12 md:w-6/12 h-8 lg:h-10 xl:h-12 3xl:h-16" target="_blank">
