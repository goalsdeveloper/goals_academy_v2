...
export default function Hero() {
    return (
        <section id="hero" className="relative flex pb-[30vw] md:pb-[8vw] pt-[15vw] md:pt-[4vw] md:px-[11vw] ">
            <img src={header_left} alt="" className="absolute md:static w-1/4 md:w-auto top-[35vw] left-5"/>
            ...
            <img src={header_right} alt="" className="absolute md:static w-1/4 md:w-auto top-[35vw] right-5"/>
        </section>
    );
}
