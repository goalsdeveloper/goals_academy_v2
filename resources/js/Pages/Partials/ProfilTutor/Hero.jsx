...
export default function Hero () {
    return (
        <section id="hero" className="my-14 xs:my-16 xl:my-24 3xl:my-32">
            <div className="container mx-auto relative flex flex-col md:flex-row justify-between items-center md:pt-4 lg:pt-8 xl:pt-12 3xl:py-20">
                <div className="w-full md:w-7/12 md:absolute h-full flex flex-col justify-center text-center md:text-start mb-8 md:mb-0">
                    ...
                    <h2>Para Tutor yang <br className="md:hidden" /><span className="text-primary">Berkeahlian di Bidangnya</span></h2>
