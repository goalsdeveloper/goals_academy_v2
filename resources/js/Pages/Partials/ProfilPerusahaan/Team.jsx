    ...
    return (
        <section id="team" className="my-16 xl:my-24 3xl:my-32 overflow-hidden">
            ...
            <div className="hidden md:block relative bg-secondary my-8 md:my-8 lg:my-12 xl:my-16 2xl:my-20 3xl:my-24">
                ...
                <div className="container-lg justify-between mx-auto flex flex-wrap py-16 text-white">
                    ...
                    <div className="md:w-6/12 lg:w-6/12 flex flex-col gap-4 relative ps-8 3xl:ps-12">
                        <img className="absolute md:w-16 lg:w-20 xl:w-24 3xl:w-32 top-[5%] right-[5%]" src={icon} alt="" />
                        <div className="flex items-end justify-center md:rounded-2xl xl:rounded-3xl overflow-hidden md:h-full bg-white  bg-opacity-30 border-4 border-white border-opacity-10">
                            <img className="md:w-9/12 lg:w-8/12" src={CEO} alt="Chief Executive Officer" />
                        </div>
                    </div>
                </div>
            </div>
