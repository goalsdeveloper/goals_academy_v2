...
export default function Preliminary () {
    return (
        <section id="preliminary" className="my-16 xl:my-24 3xl:my-32">
            <div className="relative md:bg-secondary shadow-centered-spread md:shadow-none">
                <CornerWaveVector
                    className="md:hidden"
                ...
                <div className="container mx-auto flex flex-col items-center md:gap-2 xl:gap-4 py-8 xs:py-12 md:py-6 xl:py-12">
                    ...
                    <i className="bi bi-quote text-primary md:text-white text-28 md:text-32 lg:text-48 xl:text-64 3xl:text-80 -scale-x-1 -scale-y-1"></i>
                </div>
            </div>
            <div className="relative bg-secondary md:bg-soft">
                ...
                />
                <div className="container mx-auto flex flex-col md:flex-row justify-center items-center gap-12 md:gap-4 xl:gap-8 py-16 xs:py-24 md:py-6 xl:py-12 text-secondary md:text-dark">
                    <div className="w-full md:w-3/12 rounded-lg shadow-centered-spread md:shadow-none bg-white md:bg-transparent flex justify-center items-center gap-8 md:gap-4 xl:gap-8 py-8 md:py-0">
                        ...
                        <div className="w-[40vw]">
                            <p className="font-bold text-28 xs:text-32 md:text-20 xl:text-32 3xl:text-56">21</p>
                    ...
                    <div className="w-full md:w-3/12 rounded-lg shadow-centered-spread md:shadow-none bg-white md:bg-transparent flex justify-center items-center gap-8 md:gap-4 xl:gap-8 py-8 md:py-0">
                        ...
                        <div className="w-[40vw]">
                            <p className="font-bold text-28 xs:text-32 md:text-20 xl:text-32 3xl:text-56">7</p>
                            <p className="text-dark text-16 xs:text-20 md:text-10 lg:text-12 xl:text-16 3xl:text-24">Tutor Skripsi yang berpengalaman</p>
                        </div>
                    </div>
                    <div className="w-full md:w-3/12 rounded-lg shadow-centered-spread md:shadow-none bg-white md:bg-transparent flex justify-center items-center gap-8 md:gap-4 xl:gap-8 py-8 md:py-0">
                        ...
                        <div className="w-[40vw]">
                            <p className="font-bold text-28 xs:text-32 md:text-20 xl:text-32 3xl:text-56">76</p>
                            <p className="text-dark text-16 xs:text-20 md:text-10 lg:text-12 xl:text-16 3xl:text-24">Tutor Skripsi yang berpengalaman</p>
                        </div>
                    </div>
                </div>
