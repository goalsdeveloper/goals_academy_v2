    ...
    return (
        <section id="consultation" className="my-16 xl:my-24 3xl:my-32">
            <div className="container mx-auto">
                <div className="flex flex-wrap flex-col md:flex-row items-center bg-gradient-1 md:bg-transparent shadow-centered-spread md:shadow-centered rounded-xl p-8 md:p-14 lg:p-18 xl:p-24 3xl:p-32">
