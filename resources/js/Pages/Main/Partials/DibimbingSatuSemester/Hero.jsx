    ...
    return (
        <section id="hero" className="">
            <div className="relative w-[100%] ps-[12.5vw] pe-[7.5vw] mx-auto flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-8 md:gap-0 overflow-hidden">
                <div className="absolute left-0 bottom-0 w-full sm:w-10/12 md:w-6/12 h-[40vw] overflow-hidden -z-10">
                    <img
                        className=""
                        src={gradientBg3}   
                        alt="Gradient Bg 3"
                ...
                <div className="absolute right-0 bottom-0 w-full sm:w-10/12 md:w-6/12 h-[40vw] overflow-hidden -z-10">
                    <img
