...
export default function CornerWaveVector2 ({ className, cornerClassName, rightCornerClassName, leftCornerClassName, corner2ClassName='hidden', right2CornerClassName, left2CornerClassName }) {
    return (
        <div className={`select-none ${className}`}>
            <img className={`absolute bottom-0 left-0 ${cornerClassName} ${rightCornerClassName}`} src={wave3} />
            <img className={`absolute bottom-0 left-0 ${cornerClassName} ${rightCornerClassName}`} src={wave4} />
            <img className={`absolute top-0 right-0 -scale-x-1 -scale-y-1 ${cornerClassName} ${leftCornerClassName}`} src={wave3} />
            <img className={`absolute top-0 right-0 -scale-x-1 -scale-y-1 ${cornerClassName} ${leftCornerClassName}`} src={wave4} />
