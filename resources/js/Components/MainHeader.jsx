...
export default function MainHeader () {
    return (
        <header className="fixed w-screen top-0 right-0 bg-white lg:text-base z-50">
            <nav className="container flex flex-wrap justify-between items-center mx-auto md:h-20 xl:h-32 3xl:h-48 duration-300">
                <div className='w-auto'>
                    <Link>
                        <img className='h-6 md:h-5 xl:h-8 3xl:h-10 mb-3' src={logo} alt="Goals Academy" />
                    </Link>
                </div>
                ...
                <div className='w-auto flex flex-wrap justify-end gap-2 3xl:gap-4 font-medium'>
