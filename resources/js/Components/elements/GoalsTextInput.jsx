            ...
            <div>
                <div className="relative flex">
                    <input
                        ...
                        className={`w-full flex justify-between items-center text-[3.7vw] md:text-[.8vw] focus:ring-0 focus:outline-none px-[3vw] md:px-[1vw] rounded-md text-dark h-[12vw] md:h-[3vw] border placeholder:text-light-grey ${
