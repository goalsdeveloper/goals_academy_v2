    ...
    return (
        <>
            ...
            <div
                ...
                } fixed md:absolute md:inset-0 mx-auto flex flex-col gap-[2vw] w-full md:w-[30vw] md:h-fit transition-all duration-500 bg-white shadow-md rounded-t-[6vw] md:rounded-[1vw] p-[8vw] md:p-[1.75vw] z-50  md:mt-[8vh] ${className}`}
            >
                {children}
            </div>
        </>
