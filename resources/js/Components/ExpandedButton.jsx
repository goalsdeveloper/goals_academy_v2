export default function ExpandedButton ({ className, textClassName, icon='fa-solid fa-chevron-right', iconClassName, onClick, form, type,  children }) {
    return (
        <button form={form} type={type} className={`w-full group rounded-[1vw] md:rounded-md flex justify-between items-center cursor-pointer px-[3vw] md:px-[1vw] border-1 border-light-grey ${className}`} onClick={onClick}>
