...
function useStateChangeDetection(parameters) {
  ...
  const internalPreviousStateRef = React34.useRef(initialState);
  React34.useEffect(() => {
...
function useControllableReducer(parameters) {
  const lastActionRef = React34.useRef(null);
  const {
    reducer,
    initialState,
  ...
  const reducerWithControlledState = React34.useCallback((state, action) => {
    lastActionRef.current = action;
    const controlledState = getControlledState(state, controlledProps);
    const newState = reducer(controlledState, action);
    return newState;
  }, [controlledProps, reducer]);
  const [nextState, dispatch] = React34.useReducer(reducerWithControlledState, initialState);
  const dispatchWithContext = React34.useCallback((action) => {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React35.useState("");
  const [triggerElement, setTriggerElement] = React35.useState(null);
  const lastActionType = React35.useRef(null);
  const handleStateChange = React35.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React35.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var FormControlContext2 = React37.createContext(void 0);
if (true) {
...
var FormControl = React38.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children: children2,
...
function useFormControlContext() {
  return React39.useContext(FormControlContext2);
}
...
function useListItem(parameters) {
  ...
  const createHandleClick = React45.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React45.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React46.createContext(null);
...
function useCompoundParent() {
  const [subitems, setSubitems] = React46.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React46.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React46.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React46.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React46.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React46.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const reducerActionContext = React48.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
var Menu = React50.forwardRef(function Menu2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsx)(Popper, _extends({}, rootProps, {
    open,
    anchorEl: anchor,
    slots: {
      root: Root
...
function useMenuItem(params) {
  ...
  const itemMetadata = React53.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React53.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React55.memo(React55.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled: disabledProp = false,
...
var MenuItem2 = React55.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React57.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    closeAfterTransition = false,
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React58.useState(value ? String(value) : void 0);
  React58.useEffect(() => {
...
var NumberInput = React59.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime39.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime38.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime38.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime38.jsx)(Input5, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React60.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime41.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime40.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime40.jsx)(List3, _extends({}, listProps, {
...
var Option2 = React63.forwardRef(function Option3(props, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime42.jsx)(InnerOption, _extends({}, props, {
      ref
    }))
  });
});
...
function useLatestRef(value) {
  const ref = React64.useRef(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
function useFloating(options) {
  ...
  const [data, setData] = React64.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const [latestMiddleware, setLatestMiddleware] = React64.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = React64.useState(null);
  const [_floating, _setFloating] = React64.useState(null);
  ...
  const setFloating = React64.useCallback((node) => {
  ...
  const referenceRef = React64.useRef(null);
  const floatingRef = React64.useRef(null);
  const dataRef = React64.useRef(data);
  const whileElementsMountedRef = useLatestRef(whileElementsMounted);
  const platformRef = useLatestRef(platform2);
  const update = React64.useCallback(() => {
  ...
  const isMountedRef = React64.useRef(false);
  index(() => {
  ...
  const floatingStyles = React64.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
var Popup = React65.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children: children2,
...
true ? Popup.propTypes = {
   ...
   */
  anchor: import_prop_types35.default.oneOfType([HTMLElementType, import_prop_types35.default.object, import_prop_types35.default.func]),
  /**
   * @ignore
   */
   ...
   */
  middleware: import_prop_types35.default.arrayOf(import_prop_types35.default.oneOfType([import_prop_types35.default.oneOf([false]), import_prop_types35.default.shape({
    fn: import_prop_types35.default.func.isRequired,
    name: import_prop_types35.default.string.isRequired,
    options: import_prop_types35.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.number, import_prop_types35.default.shape({
    alignmentAxis: import_prop_types35.default.number,
    crossAxis: import_prop_types35.default.number,
    mainAxis: import_prop_types35.default.number
  })]),
  /**
   ...
   * @default false
   */
  withTransition: import_prop_types35.default.bool
} : void 0;
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime45.jsx)(React68.Fragment, {
...
var Select = React68.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React68.Fragment, {
    ...
    })), (0, import_jsx_runtime45.jsx)("input", _extends({}, getHiddenInputProps(), {
      autoComplete
    }))]
  });
});
true ? Select.propTypes = {
   ...
   */
  placeholder: import_prop_types36.default.node,
  /**
...
function useSlider(parameters) {
  ...
  const sliderRef = React69.useRef();
  ...
  const previousIndex = React69.useRef();
...
var Slider = React70.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime48.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime47.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime47.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index2) => {
...
function useSnackbar(parameters = {}) {
  ...
  const timerAutoHide = React71.useRef();
  React71.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
function FirstPageIconDefault() {
  return _span22 || (_span22 = (0, import_jsx_runtime52.jsx)("span", {
    children: "|⇽"
  }));
}
...
function TabsListProvider(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime59.jsx)(ListContext.Provider, {
      value: listContextValue,
      children: children2
    })
  });
...
var InputBase = React88.forwardRef(function InputBase2(inProps, ref) {
  ...
  const {
    current: isControlled
  } = React88.useRef(value != null);
  const inputRef = React88.useRef();
  const handleInputRefWarning = React88.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React88.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
...
var ButtonGroupContext = React91.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React92.createContext(void 0);
if (true) {
...
var Button3 = React93.forwardRef(function Button4(inProps, ref) {
  ...
  const buttonGroupButtonContextPositionClassName = React93.useContext(ButtonGroupButtonContext_default);
...
var DialogContext = React95.createContext({});
if (true) {
...
var Dialog = React96.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React96.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React96.useMemo(() => {
    return {
...
var DialogActions = React97.forwardRef(function DialogActions2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogActions"
  });
...
var DialogContent = React98.forwardRef(function DialogContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogContent"
  });
...
var Divider = React99.forwardRef(function Divider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDivider"
  });
...
var FormControl3 = React101.forwardRef(function FormControl4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React101.useState(() => {
    let initialAdornedStart = false;
    if (children2) {
      React101.Children.forEach(children2, (child) => {
  ...
  const [filled, setFilled] = React101.useState(() => {
  ...
  const [focusedState, setFocused] = React101.useState(false);
  ...
  let registerEffect;
  if (true) {
    const registeredInput = React101.useRef(false);
    registerEffect = () => {
...
var FormHelperText = React102.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime76.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
    ...
    children: children2 === " " ? (
      ...
      _span5 || (_span5 = (0, import_jsx_runtime76.jsx)("span", {
        className: "notranslate",
        children: "​"
      }))
    ) : children2
...
var FormLabel = React103.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime77.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [children2, fcs.required && (0, import_jsx_runtime77.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React105.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React105["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React105.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React105.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React105.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
var InputAdornment = React107.forwardRef(function InputAdornment2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiInputAdornment"
  });
  ...
  return (0, import_jsx_runtime80.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime80.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime80.jsx)(Typography_default, {
        color: "text.secondary",
        children: children2
      }) : (0, import_jsx_runtime81.jsxs)(React107.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span6 || (_span6 = (0, import_jsx_runtime80.jsx)("span", {
            className: "notranslate",
            children: "​"
          }))
        ) : null, children2]
...
var InputLabel = React108.forwardRef(function InputLabel2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiInputLabel",
    props: inProps
  });
...
var ListContext2 = React109.createContext({});
if (true) {
...
var List = React110.forwardRef(function List2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime84.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime83.jsxs)(ListRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState
...
var ListItem = React113.forwardRef(function ListItem2(inProps, ref) {
  ...
  return (0, import_jsx_runtime87.jsx)(ListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime88.jsxs)(Root, _extends({}, rootProps, {
      ...
      children: [children2, secondaryAction && (0, import_jsx_runtime87.jsx)(ListItemSecondaryAction_default, {
...
var ListItemIcon = React114.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemIcon"
  });
...
var ListItemText = React115.forwardRef(function ListItemText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React115.useContext(ListContext_default);
...
var _excluded58 = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
...
var MenuList = React116.forwardRef(function MenuList2(props, ref) {
  ...
  const textCriteriaRef = React116.useRef({
    keys: [],
    repeating: true,
  ...
  React116.Children.forEach(children2, (child, index2) => {
  ...
  const items = React116.Children.map(children2, (child, index2) => {
  ...
  return (0, import_jsx_runtime92.jsx)(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown2,
...
var Popover = React117.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime93.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime93.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime93.jsx)(PaperSlot, _extends({}, paperProps, {
        children: children2
      }))
    }))
  }));
...
var Menu3 = React118.forwardRef(function Menu4(inProps, ref) {
  ...
  return (0, import_jsx_runtime94.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime94.jsx)(MenuMenuList, _extends({
...
var MenuItem4 = React119.forwardRef(function MenuItem5(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMenuItem"
  });
  ...
  const menuItemRef = React119.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime96.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime96.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime96.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span7 || (_span7 = (0, import_jsx_runtime96.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      )
...
var OutlinedInput = React121.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime98.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
    renderSuffix: (state) => (0, import_jsx_runtime98.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime97.jsxs)(React121.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var NativeSelectInput = React122.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime100.jsxs)(React122.Fragment, {
    children: [(0, import_jsx_runtime99.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime99.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React123.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime102.jsxs)(React123.Fragment, {
    children: [(0, import_jsx_runtime101.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span8 || (_span8 = (0, import_jsx_runtime101.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
    })), (0, import_jsx_runtime101.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime101.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime101.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var ArrowDropDown_default = createSvgIcon((0, import_jsx_runtime103.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var Select3 = React125.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime104.jsx)(React125.Fragment, {
...
var Tab3 = React127.forwardRef(function Tab4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  return (0, import_jsx_runtime106.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime106.jsxs)(React127.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime106.jsxs)(React127.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var Tabs3 = React132.forwardRef(function Tabs4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime111.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime111.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime111.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
    className: clsx_default(classes.indicator, TabIndicatorProps.className),
    ownerState,
    style: _extends({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children2 = React132.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime112.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
...
var _excluded72 = ["autoComplete", "autoFocus", "children", "className", "color", "defaultValue", "disabled", "error", "FormHelperTextProps", "fullWidth", "helperText", "id", "InputLabelProps", "inputProps", "InputProps", "inputRef", "label", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onFocus", "placeholder", "required", "rows", "select", "SelectProps", "type", "value", "variant"];
...
var TextField = React133.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime113.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime114.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime113.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime113.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children: children2
    })) : InputElement, helperText && (0, import_jsx_runtime113.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OQW7MHXK.js.map
