...
var MuiPickersAdapterContext = React31.createContext(null);
if (true) {
...
var LocalizationProvider = function LocalizationProvider2(inProps) {
  ...
  } = (_React$useContext = React31.useContext(MuiPickersAdapterContext)) != null ? _React$useContext : {
    utils: void 0,
    localeText: void 0
  };
  ...
  const localeText = React31.useMemo(() => _extends({}, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
  const utils = React31.useMemo(() => {
    if (!DateAdapter) {
      if (parentUtils) {
        return parentUtils;
      }
...
`));
  ...
  const defaultDates = React31.useMemo(() => {
    if (!utils) {
      return null;
    }
    return {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DU7L6VUV.js.map
