...
class BimbinganController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $sekali_bimbing = Products::whereHas('category', function ($q) {
                $q->where('name', 'LIKE', '%sekali%');
            })->get();
            $bimbing_tuntas = Products::whereHas('category', function ($q) {
                $q->where('name', 'LIKE', '%tuntas%');
            })->get();
