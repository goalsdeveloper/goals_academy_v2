        ...
        try {
            return Inertia::render('Auth/Admin/Webinar/Order', [
                ...
                'orders' => function () use ($request) {
                    ...
                    $query = Order::with(['paymentMethod:id,name', 'user:id,username,name', 'products:id,product_type_id,category_id,name,product_image,webinar_properties', 'products.category:id,name', 'products.productType:id,type'])
