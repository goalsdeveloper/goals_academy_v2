...
class ProgressController extends Controller
{
    ...
    public function show(Course $progress)
    {
        try {
            ...
            if (Auth::user()->user_role == "moderator") {
                $progress_user = Course::with("addOns","user:id,username", "user.profile:id,user_id,university,major,phone_number,faculty", "tutor:id,name", "topic:id,topic", "place", "place.city", "order:id,order_code", "products:id,name,contact_type,duration", "fileUploads", "productReview")->findOrFail($progress->id);
                // return response()->json([
                //     "status" => true,
                //     "statusCode" => 200,
