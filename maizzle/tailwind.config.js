  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-1":
          "linear-gradient(165deg, #FFE6DB -0.04%, #FF8854 180.59%);",
        "gradient-2":
          "linear-gradient(125deg, rgba(255, 255, 255, 0.34) -0.03%, rgba(237, 113, 60, 0.34) 53.15%, rgba(255, 255, 255, 0.34) 101.07%);",
        "sweep-primary":
          "linear-gradient(120deg, #FF6420 90%, transparent 10%)",
      ...
      content: {
        ...
        "arrow-right-secondary-16":
          "url(/resources/img/icon/arrow-right-secondary-16.svg)",
        "arrow-right-secondary-20":
          "url(/resources/img/icon/arrow-right-secondary-20.svg)",
        "arrow-right-secondary-24":
          "url(/resources/img/icon/arrow-right-secondary-24.svg)",
        "arrow-right-secondary-32":
          "url(/resources/img/icon/arrow-right-secondary-32.svg)",
      },
      boxShadow: {
